...
+ [獲得Places服務的訪問權](places-gain-access.md)
+ Places服務UI {#poi-mgmt-ui}
   + [Places服務UI概述](poi-mgmt-ui/poi-mgmt-ui-overview.md)
...
+ 網站服務API {#web-service-api}
   ...
   + API使用情況 {#api-usage}
      ...
      + 管理程式庫 {#manage-libraries}
         ...
         + [閱讀程式庫](web-service-api/api-usage/manage-libraries/read-a-library.md)
         ...
         + [閱讀組織中的所有程式庫](web-service-api/api-usage/manage-libraries/read-all-libraries-in-your-organization.md)
         + [在程式庫上設定排名](web-service-api/api-usage/manage-libraries/set-a-ran-on-your-libraries.md)
         + [取得程式庫的排名](web-service-api/api-usage/manage-libraries/get-a-librarys-rank.md)
      + 管理地標 {#manage-pois}
         ...
         + [閱讀貴組織中的所有POI](web-service-api/api-usage/manage-pois/read-all-pois-in-your-organization.md)
         + 批次API {#batch-apis}
...
+ 行動SDK的擴充功能 {#places-ext-aep-sdks}
   + Places 擴充功能 {#places-extension}
      ...
      + [自定義放置對象](places-ext-aep-sdks/places-extension/cust-places-objects.md)
+ [將Places Service與您自己的監控解決方案搭配使用](using-your-own-monitor.md)
+ [不使用活動區域監視的Places服務](use-places-without-active-monitoring.md)
+ 使用Places Service作為Experience Platform Launch工作流程的一部分 {#use-places-launch-workflow}
   + [使用Places Service作為Experience Platform Launch工作流程的一部分](use-places-launch-workflow/places-launch-workflow.md)
...
+ 將Places服務與其他Adobe解決方案搭配使用 {#use-places-with-other-solutions}
   + Adobe Analytics {#places-adobe-analytics}
      + [搭配使用Places服務Adobe Analytics](use-places-with-other-solutions/places-adobe-analytics/use-places-analytics-overview.md)
      + [傳送POI項目和退出資料至Analytics](use-places-with-other-solutions/places-adobe-analytics/use-places-adobe-analytics.md)
      + [將位置內容新增至Analytics請求](use-places-with-other-solutions/places-adobe-analytics/run-reports-aa-places-data.md)
      + [報告Analytics工作區中的位置資料](use-places-with-other-solutions/places-adobe-analytics/places-in-workspace.md)
   ...
   + Adobe Campaign Standard {#places-acs}
      + [搭配使用Places服務Adobe Campaign Standard](use-places-with-other-solutions/places-acs/places-acs-overview.md)
   ...
   + Adobe Target {#places-target}
      + [搭配使用Places服務Adobe Target](use-places-with-other-solutions/places-target/places-target.md)
