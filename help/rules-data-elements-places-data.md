...
資料元素是變數，而此變數的值可對映至查詢字串、URL、Cookie值、JavaScript變數等。 在Experience Platform Launch中，您可以利用變數名稱參考此值。 資料元素的集合會變成定義資料的字典，您可用來建立規則（事件、條件和動作），而資料字典則會在Experience Platform Launch間共用，並與Places擴充功能搭配使用。
