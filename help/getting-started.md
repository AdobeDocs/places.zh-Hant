...
Places服務產品內容適用於所有Experience Cloud組織。

* 確保您在Admin Console中的Places服務和Experience Platform Launch產品內容底下被列為使用者。

  如需詳細資訊，請參閱[常見問題集](/help/places-gain-access.md)中的&#x200B;*新增使用者至Experience Platform Launch and Places Service*。
