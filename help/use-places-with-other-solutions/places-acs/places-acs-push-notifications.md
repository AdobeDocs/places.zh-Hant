...
除了Places服務的資料元素之外，請確定您還為&#x200B;*應用程式ID*&#x200B;和&#x200B;*Experience Cloud ID*&#x200B;建立行動核心資料元素。
...
>[!IMPORTANT]
>
>* 將Slack Web勾點設定為其他動作，以驗證是否正在觸發專案，以及是否正在收集正確的資料可能會有幫助。
...
1. 在頂端再次執行計數，以檢視您的對象人數變化。
   ...
   如果您沒有看到計數更新，表示您輸入的POI名稱可能沒有任何裝置觸發專案。 在這種情況下，擁有Slack Web勾點變得很有價值，因為您可以看到來自各種測試裝置的POI專案清單。
